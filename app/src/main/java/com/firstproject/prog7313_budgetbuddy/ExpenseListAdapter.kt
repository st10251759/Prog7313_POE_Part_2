...
class ExpenseListAdapter(
    ...
    inner class ExpenseViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(expense: Expense) {
            ...
            tvDayOfMonth.text = dateFormat.format(expenseDate)
            tvMonth.text = monthFormat.format(expenseDate).uppercase()
            ...
            // Show the download button only if a photoUrl or photoPath is available
            if (!expense.photoUrl.isNullOrEmpty() || !expense.photoPath.isNullOrEmpty()) {
